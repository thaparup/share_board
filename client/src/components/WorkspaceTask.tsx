...
const WorkspaceTask = ({ tasks, workspaceId }: Props) => {
    ...
    const handleNavigateToCreateTask = () => {
        navigate({
            to: '/workspaces/$workspaceId/task/create',
            params: { workspaceId },
        })
    }
    ...
    return (
        <div className="mt-12">
            <div className="flex justify-between items-center mb-4">
                ...
                <Button
                    className="bg-indigo-600 hover:bg-indigo-700 text-white px-3 py-2 rounded-md mr-8 flex items-center text-sm cursor-pointer"
                ...
                {tasks?.length === 0 && (
                    <div className="col-span-full text-center py-12 bg-gray-800 rounded-lg">
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                            Get started by creating a new task for this workspace.
                        </p>
                    </div>
                )}
            </div>
